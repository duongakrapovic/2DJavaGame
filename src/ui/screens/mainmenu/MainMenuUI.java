...
public class MainMenuUI extends BaseUI {
    ...
    private BufferedImage[][] buttonImgs; // [4 hàng][3 cột]
    ...
    private void initButtons() {
        ...
        int tileW = buttonAtlas.getWidth() / 3;
        int tileH = buttonAtlas.getHeight() / 4;
    ...
    public void draw(Graphics2D g2) {
        ...
        for (int i = 0; i < 4; i++) {
            int state = (i == focusIndex) ? 1 : 0; // 1=focus
    ...
    public void select() {
        ...
        switch (focusIndex) {
            ...
            case 3 -> showingCredits = true; //CREDITSy
        }
    }
