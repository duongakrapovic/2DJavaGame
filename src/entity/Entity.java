...
public class Entity {
    ...
    public void draw(Graphics2D g2){
        int screenX = worldX - gp.em.getPlayer().worldX + gp.em.getPlayer().screenX;
        int screenY = worldY - gp.em.getPlayer().worldY + gp.em.getPlayer().screenY;
        
        if(worldX + gp.tileSize > gp.em.getPlayer().worldX - gp.em.getPlayer().screenX &&
           worldX - gp.tileSize < gp.em.getPlayer().worldX + gp.em.getPlayer().screenX &&
           worldY + gp.tileSize > gp.em.getPlayer().worldY - gp.em.getPlayer().screenY &&
           worldY - gp.tileSize < gp.em.getPlayer().worldY + gp.em.getPlayer().screenY){
